...
public class AbsoluteDriveAdv extends Command
{
  ...
  private final BooleanSupplier look1, look2, look3, look4, look5, look6;
   ...
   * @param look5     Face the robot right
   */
  public AbsoluteDriveAdv(SwerveSubsystem swerve, DoubleSupplier vX, DoubleSupplier vY, DoubleSupplier headingAdjust,
                          BooleanSupplier look1, BooleanSupplier look2, BooleanSupplier look3,
                          BooleanSupplier look4, BooleanSupplier look5, BooleanSupplier look6)
  {
    this.swerve = swerve;
    this.vX = vX;
    this.vY = vY;
  ...
  public void execute()
  {
    ...
    if (look1.getAsBoolean())     // REEF D
    {
      headingX = 0;
      headingY = 1;
    }
    if (look2.getAsBoolean())     // REEF E
    {
      headingX = 0.95;
      headingY = 0.56;
    }
    if (look3.getAsBoolean())     // REEF B
    {
      headingX = -0.95;
      headingY = -0.56;
    }
    if (look4.getAsBoolean())     // REEF A
    {
      headingX = 0;
      headingY = -1;
    }
    if (look5.getAsBoolean())     // REEF C
    {
      headingX = -0.95;
      headingY = 0.56;
    }
    if (look6.getAsBoolean())     // REEF F
    {
      headingX = 0.95;
      headingY = -0.56;
    }
